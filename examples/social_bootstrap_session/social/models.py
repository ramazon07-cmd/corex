"""
Social-specific models for social app.
...
class Profile(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('social:profile_detail', kwargs={'username': self.user.username})
    
    def update_counts(self):
        """Update follower/following/posts counts."""
        self.followers_count = self.user.social_followers.count()
        self.following_count = self.user.social_following.count()
        self.posts_count = self.user.social_posts.count()
...
class Follow(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if hasattr(self.follower, 'social_profile'):
            self.follower.social_profile.update_counts()
        if hasattr(self.following, 'social_profile'):
            self.following.social_profile.update_counts()
    ...
    def delete(self, *args, **kwargs):
        ...
        if hasattr(follower, 'social_profile'):
            follower.social_profile.update_counts()
        if hasattr(following, 'social_profile'):
            following.social_profile.update_counts()
...
class Post(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if hasattr(self.author, 'social_profile'):
            self.author.social_profile.update_counts()
...
class CommentLike(models.Model):
    """Comment like model."""
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='social_comment_likes')
...
class Notification(models.Model):
    ...
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='social_sent_notifications')
