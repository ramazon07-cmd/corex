"""
CRM-specific models for crm app.
...
class Company(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('crm:company_detail', kwargs={'slug': self.slug})
...
class Contact(models.Model):
    ...
    assigned_to = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='crm_contacts')
...
class Deal(models.Model):
    ...
    assigned_to = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='crm_deals')
    description = models.TextField(blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Task(models.Model):
    ...
    assigned_to = models.ForeignKey(User, on_delete=models.CASCADE, related_name='crm_tasks')
