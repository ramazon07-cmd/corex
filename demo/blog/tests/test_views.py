...
class ItemViewTest(TestCase):
    ...
    def test_item_list_view(self):
        ...
        response = self.client.get(reverse('blog:item_list'))
    ...
    def test_item_detail_view(self):
        ...
        response = self.client.get(reverse('blog:item_detail', args=[self.item.pk]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_item_create_view_requires_login(self):
        ...
        response = self.client.get(reverse('blog:item_create'))
    ...
    def test_item_create_post(self):
        ...
        response = self.client.post(reverse('blog:item_create'), data)
    ...
    def test_item_update_view_requires_ownership(self):
        ...
        response = self.client.get(reverse('blog:item_update', args=[self.item.pk]))
    ...
    def test_item_delete_view(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.get(reverse('blog:item_delete', args=[self.item.pk]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_item_delete_post(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.post(reverse('blog:item_delete', args=[self.item.pk]))
        self.assertEqual(response.status_code, 302)  # Redirect after success
