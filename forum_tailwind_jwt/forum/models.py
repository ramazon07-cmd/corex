"""
Forum-specific models for forum app.
...
class Post(models.Model):
    ...
    edited_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='forum_edited_posts')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class UserProfile(models.Model):
    ...
    def update_stats(self):
        ...
        self.posts_count = self.user.forum_posts.count()
        self.topics_count = self.user.forum_topics.count()
